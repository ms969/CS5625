...
public class CustomSceneController extends SceneController {
	...
	private float dt = System.nanoTime()/1000000f;
	...
	public void initializeScene()
	{
		try
		{
			...
			moonlight.setColor(new Color3f(0.8f,0.8f,1.0f));
			moonlight.setPosition(new Point3f(10.0f,12.0f,10.0f));
			moonlight.setQuadraticAttenuation(0.005f);
			mSceneRoot.addChild(moonlight);
			...
			Runnable r = new Runnable() {   
			     public void run() {  
			           try {
			        	   while(true) {
			        		   nextFrame(System.nanoTime()/1000000f - dt);
			        		   dt = System.nanoTime()/1000000f;
