...
public abstract class Mesh implements OpenGLResourceObject
{
	...
	protected void computeAndAccumulateTangentVectors(int i1, int i2, int i3, float tan1[], float[] tan2) {
		...
		/* TODO PA5 Prereq (Optional): Construct the Q matrix */
		...
		/* TODO PA5 Prereq (Optional): Construct the inverse (s,t) matrix, and compute 
	...
	protected FloatBuffer averageAndNormalizeAllTangentVectors(float tan1[], float[] tan2) {
		...
		for (int vIndex = 0; vIndex < getVertexCount(); ++vIndex)
		{
			...
			/* TODO PA5 Prereq (Optional): Orthogonalize and normalize (aka. create orthonormal basis), based on
			...
			/* TODO PA5 Prereq (Optional): Compute handedness of bitangent, as explained on Lengyel's site. */			
