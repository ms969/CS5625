 ...
 * 
 * Implements the Blinn-Phong shading model with the option for a classic normal map.
 * 
...
public class ClassicNormalMapMaterial extends Material{
	...
	public ClassicNormalMapMaterial(Color3f diffuseColor, Texture2D normalTexture) {
